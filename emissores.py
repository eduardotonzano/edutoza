...
_EXTRA = {
 ...
 "Localiza":      _e("Localiza", "Localiza aluguel carros", ["localiza"], [], ["locacao","aluguel de carros","frota","seminovos"], ["localiza","locacao das americas"], categoria="Locacao", aliases=["localiza","locacao das americas"]),
 "Movida":        _e("Movida", "Movida locacao", ["movida"], [], ["locacao","aluguel de carros","frota","seminovos"], ["movida"], categoria="Locacao", aliases=["movida"]),
 ...
 "Oracle":        _e("Oracle", "Oracle software cloud", ["oracle"], [], ["software","cloud","database","ellison"], sec_ticker="ORCL", sec_cik="0001341439", categoria="Tech US", aliases=["oracle"]),
