...
def main() -> int:
    ...
    for anos in JANELAS_ANOS:
        ...
        resultado = calcular_janela(rotulo, anos, dolar, cdi, data_fim, spread_aa=args.spread)
    ...
    if not janelas:
        print("ERRO: nenhuma janela pôde ser calculada — dados insuficientes.")
        return 1

    caminho = gerar_documento(janelas, series_dolar_por_janela, args.spread,
                               caminho_saida=args.saida, amostra=args.amostra)
